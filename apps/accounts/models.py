...
class AccountManager(BaseUserManager):
    def create_user(self, username, password=None, **extra_fields):
        if username is None:
            raise TypeError(_('User must have a username'))
...
class Account(AbstractBaseUser, PermissionsMixin):
    ...
    phone = models.CharField(max_length=50, verbose_name=_('Phone number'), null=True)
    ...
    role = models.ImageField(choices=ROLE, default=1)
